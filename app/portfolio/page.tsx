...
export const metadata: Metadata = {
  ...
  description: "See our recent work — AI Automation, Full-Stack Development, and AI Integration projects.",
};

const categories = ["All", "AI Automation", "Full-Stack", "AI Integration"];

const portfolioItems = [
  {
    title: "NeuralFlow Dashboard",
    category: "AI Automation",
    shortDesc: "Intelligent workflow automation platform for a logistics client. Reduced manual processing time by 80%.",
  ...
  },
  {
    ...
    category: "Full-Stack",
    shortDesc: "End-to-end e-commerce platform with AI-powered product recommendations and dynamic pricing.",
  ...
  },
  {
    ...
    shortDesc: "RAG-powered chatbot trained on internal HR docs and SOPs. Deployed for a 200-person company.",
          ...
          <div className="container-main">
            <ScrollReveal>
              ...
              <p className="text-text-secondary mt-4 max-w-2xl text-lg">
                A showcase of our recent projects across AI, automation, and full-stack
                development.
              </p>
            </ScrollReveal>
